...
const translations: Translations = {
    ...
    welcomeMessage: {
        ...
        cat: 'Hola! 👋 Sóc el bot del Mooot\n\nJugueu diariament a t.me/mooot_cat_bot/mooot, compartiu el resultat en aquet grup i començarà la competició! Jo m’encarregaré de mantenir una classificació i donar premis als millors.\n\nEnvieu /classificacio sempre que vulgueu per veure com va la lliga, i /instruccions per veure més detalls del que puc fer.',
