...
const translations: Translations = {
  ...
  legendExplain: {
    es:
      "Se otorgarán los puntos al mandar los resultados al chat, y se reaccionará al comentario con el emoji correspondiente",
    cat:
      "S'otorgaran els punts al enviar els resultats al xat, i es reaccionarà al comentari amb l'emoji corresponent",
    en:
      "Points will be awarded when sending results to the chat, and the comment will be reacted to with the corresponding emoji",
  },
  finalAdviseTitleA: {
